...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=george.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x20, 0x2e, 0x67, 0x65, 0x6f, 0x72, 0x67, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
	...
	0x2e, 0x67, 0x65, 0x6f, 0x72, 0x67, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53,
	...
	0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x62, 0x3b,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: george.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: george.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: george.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: george.pcbook.Screen.resolution:type_name -> george.pcbook.Screen.Resolution
	0, // 1: george.pcbook.Screen.panel:type_name -> george.pcbook.Screen.Panel
