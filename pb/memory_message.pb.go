...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=george.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x67, 0x65, 0x6f, 0x72, 0x67, 0x65, 0x2e, 0x70, 0x63,
	...
	0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x62, 0x3b, 0x70,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: george.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: george.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: george.pcbook.Memory.unit:type_name -> george.pcbook.Memory.Unit
