...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x67, 0x65, 0x6f, 0x72, 0x67,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: george.pcbook.CPU
	(*GPU)(nil),    // 1: george.pcbook.GPU
	(*Memory)(nil), // 2: george.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: george.pcbook.GPU.memory:type_name -> george.pcbook.Memory
