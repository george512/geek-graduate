...
func TestClientCreateLaptop(t *testing.T) {
	...
	serverAddress := startTestLaptopServer(t, data.NewInMemoryLaptopStore(), nil, nil)
	...
	res, err := laptopClient.CreateLaptop(context.TODO(), req)
...
func startTestLaptopServer(t *testing.T, laptopStore data.LaptopStore, imageStore data.ImageStore, ratingStore data.RatingStore) string {
...
func newTestLaptopClient(t *testing.T, serverAddress string) pb.CreateLaptopClient {
	conn, err := grpc.Dial(serverAddress, grpc.WithInsecure())
	require.NoError(t, err)
	return pb.NewCreateLaptopClient(conn)
}
...
func TestClientSearchLaptop(t *testing.T) {
	...
	laptopStore := data.NewInMemoryLaptopStore()
...
func TestUploadImage(t *testing.T) {
	...
	testImageFolder := "../imgtest/"

	// 初始化laptopStore和
	laptopStore := data.NewInMemoryLaptopStore()
	imageStore := data.NewDiskImageStore(testImageFolder)
